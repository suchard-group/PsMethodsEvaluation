...
OhdsiRTools::checkUsagePackage("LegendT2dmTestCases")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/LegendT2dmTestCases.pdf")
shell("R CMD Rd2pdf ./ --output=extras/LegendT2dmTestCases.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "LegendT2dmTestCases")
...
OhdsiRTools::createRenvLockFile("LegendT2dmTestCases")
