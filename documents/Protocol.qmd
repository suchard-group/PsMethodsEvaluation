...
OHDSI takes this larger approach, where the PS is modeled using a large-scale logistic regression model that utilizes between 10,000 and 100,000 baseline patient characteristics [@ohdsiBookOHDSIObservational2019;@tianEvaluatingLargescalePropensity2018].
...
How does variable selection for the PS model affect the results of those adjustment techniques?
