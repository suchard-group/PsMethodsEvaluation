...
[MAS: where is the Responsible Parties section? please follow https://ohdsi-studies.github.io/LegendT2dm/Protocol.html#2_Responsible_Parties]{.aside}


## Abstract

[MAS: please add ASAP]{.aside}

## Rationale and Background

The new-user cohort method attempts to emulate randomized clinical trials for observational data. 
[MAS: George does not like sentences that begin with "However $\ldots$" Fixed here; but please fix elsewhere]{.aside}
...
By matching, stratifying, or weighting patients based on their propensity scores, researchers aim to achieve balance in the measured covariates between treatment groups. [MAS: not really; they aim to remove bias in the outcome risk estimate.]{.aside}
...
However, since each patient's subsequent matches beyond their first may be less similar to them and less optimal, going beyond one-to-one matching may result in increased bias.
...
[MAS: since there is 1:5, etc. matching, you need to consider _all_ 12 ordered T/C pairs]{.aside}
...
[MAS: missing an IMPORTANT section on the performance metrics you will compute for each variant. what will you report out? also, how will you decide which is best (if possible)?  did you look at the EUMAEUS and BETTER protocols? https://suchard-group.github.io/Better/Protocol.html#84_Metrics]{.aside}
...
[MAS: what about IRB approval if necessary?]{.aside}
...
[MAS: see https://suchard-group.github.io/Better/Protocol.html#12_Plans_for_Disseminating_and_Communicating_Study_Results]{.aside}
